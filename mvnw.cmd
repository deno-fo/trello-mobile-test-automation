...
trap { if ($TMP_DOWNLOAD_DIR.Exists) { Remove-Item $TMP_DOWNLOAD_DIR -Recurse -Force -ErrorAction SilentlyContinue | Out-Null } }
...
Get-ChildItem -Path "$TMP_DOWNLOAD_DIR" -Directory | ForEach-Object {
  if (Test-Path -Path (Join-Path $_.FullName "bin/$MVN_CMD") -PathType Leaf) { $actualDistributionDir = $_.Name }
}
...
Remove-Item $TMP_DOWNLOAD_DIR -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Write-Output "MVN_CMD=$MAVEN_HOME/bin/$MVN_CMD"
